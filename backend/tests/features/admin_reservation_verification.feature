...
# Cenarios service-level: operacoes e efeitos no estado interno, sem UI.
...
Feature: Verificacao de Reservas servico
  ...
  Scenario: Listagem prioriza reservas de docentes
    ...
    And existe a reserva "1" associada ao papel "discente" para a sala "Lab 1" das "2026-07-01T08:00:00" as "2026-07-01T10:00:00"
  ...
  Scenario: Confirmar uma reserva pendente
    ...
    When Erick solicita a confirmacao da reserva "105"
  ...
  Scenario: Negar uma reserva pendente sem justificativa
    ...
    When Erick solicita a negacao da reserva "106" sem informar justificativa
  ...
  Scenario: Reserva ja decidida e imutavel
    ...
    When Erick solicita a confirmacao da reserva "107"
