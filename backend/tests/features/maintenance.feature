Feature: maintenance
  ...
  Scenario: Criar solicitação de manutenção com sucesso
    Given o sistema não possui solicitação pendente do professor "Breno Miranda" para a sala "Grad 2"
    When o sistema recebe uma solicitação do professor "Breno Miranda" para a sala "Grad 2" com descrição "Ar-condicionado com defeito"
  ...
  Scenario: Falha ao criar solicitação com campo descrição vazio
    Given o sistema não possui solicitação pendente do professor "Breno Miranda" para a sala "Grad 2"
    When o sistema recebe uma solicitação do professor "Breno Miranda" para a sala "Grad 2" sem descrição
    Then o sistema não registra a solicitação
  ...
  Scenario: Falha ao criar solicitação com descrição excessivamente longa
    Given o sistema não possui solicitação pendente do professor "Breno Miranda" para a sala "Grad 2"
    When o sistema recebe uma solicitação do professor "Breno Miranda" para a sala "Grad 2" com descrição de 501 caracteres
    Then o sistema não registra a solicitação
  ...
  Scenario: Falha ao criar solicitação para sala inexistente
    ...
    When o sistema recebe uma solicitação do professor "Breno Miranda" para a sala "Sala Inexistente" com descrição "Problema qualquer"
    Then o sistema não registra a solicitação
  ...
  Scenario: Excluir solicitação com status pendente
    Given o sistema possui uma solicitação com status "pending" do professor "Breno Miranda" para a sala "Grad 2"
    ...
    And o sistema não retorna mais essa solicitação para o professor "Breno Miranda"

  Scenario: Falha ao excluir solicitação já confirmada
    Given o sistema possui uma solicitação com status "confirmed" do professor "Breno Miranda" para a sala "Grad 2"
    When o sistema recebe uma requisição de exclusão dessa solicitação pelo seu ID
  ...
  Scenario: Editar descrição de solicitação com status pendente
    Given o sistema possui uma solicitação com status "pending" do professor "Breno Miranda" para a sala "Grad 2" com descrição "Ar-condicionado com defeito"
  ...
  Scenario: Falha ao editar solicitação já confirmada
    Given o sistema possui uma solicitação com status "confirmed" do professor "Breno Miranda" para a sala "Grad 2" com descrição "Ar-condicionado com defeito"
    When o sistema recebe uma requisição de edição dessa solicitação pelo seu ID com descrição "Ar-condicionado barulhento e com defeito"
